...
public abstract class GeneralItemAnimator extends BaseItemAnimator {
  ...
  public boolean animateRemove(final RecyclerView.ViewHolder holder) {
    if (mDebug) {
      Timber.d(TAG, "animateRemove(id = " + holder.getItemId() + ", position = " + holder.getLayoutPosition() + ")");
    }
  ...
  public boolean animateAdd(final RecyclerView.ViewHolder holder) {
    if (mDebug) {
      Timber.d(TAG, "animateAdd(id = " + holder.getItemId() + ", position = " + holder.getLayoutPosition() + ")");
    }
  ...
  public boolean animateMove(RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
    if (mDebug) {
      Timber.d(TAG, "animateMove(id = " + holder.getItemId() + ", position = " + holder.getLayoutPosition() + ", fromX = " + fromX + ", fromY = " + fromY + ", toX = " + toX + ", toY = " + toY + ")");
    }
  ...
  public boolean animateChange(
    ...
    if (mDebug) {
      ...
      Timber.d(TAG, "animateChange(old.id = " + oldId + ", old.position = " + oldPosition + ", new.id = " + newId + ", new.position = " + newPosition
  ...
  public boolean dispatchFinishedWhenDone() {
    if (mDebug && !isRunning()) {
      Timber.d(TAG, "dispatchFinishedWhenDone()");
    }
