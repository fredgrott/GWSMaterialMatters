 ...
 * {R.styleable#Transition}.</p>

 */
@SuppressWarnings({"Range", "WrongConstant"})
public class Fade extends Visibility {
    ...
    private Animator createAnimation(View view, float startAlpha, float endAlpha,
        ...
        final ObjectAnimator anim = ObjectAnimator.ofFloat(view, "alpha", startAlpha,
                endAlpha);
        if (DBG) {
            Timber.d(LOG_TAG, "Created animator " + anim);
        }
        if (listener != null) {
...
//            anim.addPauseListener(listener);
    ...
    public Animator onAppear(ViewGroup sceneRoot,
        ...
        if (DBG) {
            ...
            Timber.d(LOG_TAG, "Fade.onAppear: startView, startVis, endView, endVis = " +
    ...
    public Animator onDisappear(ViewGroup sceneRoot,
        ...
        if (DBG) {
            Timber.d(LOG_TAG, "Fade.onDisappear: startView, startVis, endView, endVis = " +
                    startView + ", " + startVisibility + ", " + endView + ", " + endVisibility);
        }
