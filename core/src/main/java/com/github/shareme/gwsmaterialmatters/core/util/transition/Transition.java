...
package com.github.shareme.gwsmaterialmatters.core.util.transition;
 ...
 *
 * {development/samples/ApiDemos/res/transition/changebounds.xml ChangeBounds}
 *
 ...
 * takes a set of {R.styleable#TransitionTarget target} tags, each
 ...
 * {R.styleable#TransitionTarget}, and {R.styleable#Fade}.
 *
 */
...
public abstract class Transition implements Cloneable {
     ...
     * and calls { #createAnimator(ViewGroup, TransitionValues, android.support.transition.TransitionValues)}
     ...
     * { #createAnimator(ViewGroup, TransitionValues, android.support.transition.TransitionValues)}.
