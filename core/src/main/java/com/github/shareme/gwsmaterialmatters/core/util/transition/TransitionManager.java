 ...
 * {@link Scene#getSceneForLayout(ViewGroup, int, android.content.Context)}. For the
...
public class TransitionManager {
     ...
     * Equivalent to calling {#beginDelayedTransition(ViewGroup, android.support.transition.Transition)}
