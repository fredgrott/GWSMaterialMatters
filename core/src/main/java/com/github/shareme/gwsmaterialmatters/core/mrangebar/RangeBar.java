 ...
 * under the License.
 */
package com.github.shareme.gwsmaterialmatters.core.mrangebar;
...
public class RangeBar extends View {
  ...
  public void setTickStart(float tickStart) {
    ...
    if (isValidTickCount(tickCount)) {
      ...
      Timber.e(TAG, "tickCount less than 2; invalid tickCount.");
  ...
  private void rangeBarInit(Context context, AttributeSet attrs) {
    ...
    try {
      ...
      if (isValidTickCount(tickCount)) {
        ...
        Timber.e(TAG, "tickCount less than 2; invalid tickCount. XML input ignored.");
      }
