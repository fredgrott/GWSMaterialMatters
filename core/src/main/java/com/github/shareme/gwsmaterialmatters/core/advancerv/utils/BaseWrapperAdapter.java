 ...
 */
package com.github.shareme.gwsmaterialmatters.core.advancerv.utils;
...
public class BaseWrapperAdapter<VH extends RecyclerView.ViewHolder>
  ...
  /*package*/ final void onWrappedAdapterChanged() {
    if (LOCAL_LOGD) {
      Timber.d(TAG, "onWrappedAdapterChanged");
    }
  ...
  /*package*/ final void onWrappedAdapterItemRangeChanged(int positionStart, int itemCount) {
    if (LOCAL_LOGD) {
      Timber.d(TAG, "onWrappedAdapterItemRangeChanged(positionStart = " + positionStart + ", itemCount = " + itemCount + ")");
    }
  ...
  /*package*/ final void onWrappedAdapterItemRangeChanged(int positionStart, int itemCount, Object payload) {
    if (LOCAL_LOGD) {
      Timber.d(TAG, "onWrappedAdapterItemRangeChanged(positionStart = " + positionStart + ", itemCount = " + itemCount + ", payload = " + payload + ")");
    }
  ...
  /*package*/ final void onWrappedAdapterItemRangeInserted(int positionStart, int itemCount) {
    if (LOCAL_LOGD) {
      Timber.d(TAG, "onWrappedAdapterItemRangeInserted(positionStart = " + positionStart + ", itemCount = " + itemCount + ")");
    }
  ...
  /*package*/ final void onWrappedAdapterItemRangeRemoved(int positionStart, int itemCount) {
    if (LOCAL_LOGD) {
      Timber.d(TAG, "onWrappedAdapterItemRangeRemoved(positionStart = " + positionStart + ", itemCount = " + itemCount + ")");
    }
  ...
  /*package*/ final void onWrappedAdapterRangeMoved(int fromPosition, int toPosition, int itemCount) {
    if (LOCAL_LOGD) {
      Timber.d(TAG, "onWrappedAdapterRangeMoved(fromPosition = " + fromPosition + ", toPosition = " + toPosition + ", itemCount = " + itemCount + ")");
    }
