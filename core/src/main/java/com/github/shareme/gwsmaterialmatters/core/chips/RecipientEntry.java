...
public class RecipientEntry {
  ...
  /** Type of the destination like {@link ContactsContract.CommonDataKinds.Email#TYPE_HOME} */
  private final int mDestinationType;
  /**
   * Label of the destination which will be used when type was {@link ContactsContract.CommonDataKinds.Email#TYPE_CUSTOM}.
   ...
   * {@link ContactsContract.DisplayNameSources#PHONE} we use the contact's display name, but if not,
