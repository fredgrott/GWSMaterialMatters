...
import com.github.shareme.gwsmaterialmatters.core.advancerv.animator.SwipeDismissItemAnimator;
...
public class RecyclerViewSwipeManager implements SwipeableItemConstants {
  ...
  private void handleActionUpOrCancelWhileSwiping(int action) {
    ...
    if (LOCAL_LOGD) {
      Timber.d(TAG, "swiping finished  --- result = " + result);
    }
