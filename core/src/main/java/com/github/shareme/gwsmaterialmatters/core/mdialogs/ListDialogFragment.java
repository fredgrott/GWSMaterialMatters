 ...
 * <p/>
 * Implement {@link ListDialogListener} to handle selection of single and no choice
 * modes. Implement {@link MultiChoiceListDialogListener} to handle selection of
 * multi choice.
...
public class ListDialogFragment extends BaseDialogFragment {
  ...
  private void buildNormalChoice(Builder builder) {
    builder.setItems(
            ...
            new AdapterView.OnItemClickListener() {
              @Override
              public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                for (ListDialogListener listener : getSingleDialogListeners()) {
    ...
    if (!TextUtils.isEmpty(getNegativeButtonText())) {
      builder.setNegativeButton(getNegativeButtonText(), new View.OnClickListener() {
        ...
        public void onClick(View view) {
          for (SimpleDialogCancelListener listener : getCancelListeners()) {
        ...
        case AbsListView.CHOICE_MODE_MULTIPLE:
          positiveButtonClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              for (MultiChoiceListDialogListener listener : getMutlipleDialogListeners()) {
   ...
   * @since 2.1.0
   */
  private List<ListDialogListener> getSingleDialogListeners() {
    return getDialogListeners(ListDialogListener.class);
  }
   ...
   * @since 2.1.0
   */
  private List<MultiChoiceListDialogListener> getMutlipleDialogListeners() {
    return getDialogListeners(MultiChoiceListDialogListener.class);
  }
