...
public class TransitionInflater {
        ...
        while (((type=parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if ("fade".equals(name)) {
                TypedArray a = mContext.obtainStyledAttributes(attrs,
                        R.styleable.Fade);
                int fadingMode = a.getInt(R.styleable.Fade_fadingMode,
                        Fade.IN | Fade.OUT);
                ...
                int ordering = a.getInt(
                        R.styleable.TransitionSet_transitionOrdering,
        ...
        while (((type=parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if (name.equals("target")) {
                ...
                int id = a.getResourceId(
                        R.styleable.TransitionTarget_targetId, -1);
                if (id >= 0) {
                    targetIds.add(id);
                }
            } else {
    ...
    private Transition loadTransition(Transition transition, AttributeSet attrs)
        ...
        TypedArray a =
                mContext.obtainStyledAttributes(attrs, R.styleable.Transition);
