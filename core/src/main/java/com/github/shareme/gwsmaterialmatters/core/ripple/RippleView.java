...
package com.github.shareme.gwsmaterialmatters.core.ripple;
...
/**
 * Created by fgrott on 6/26/2016.
 */
...
public class RippleView extends Button {
  ...
  public boolean onTouchEvent(final MotionEvent event) {
    Timber.d("TouchEvent", String.valueOf(event.getActionMasked()));
    Timber.d("mIsAnimating", String.valueOf(mIsAnimating));
    Timber.d("mAnimationIsCancel", String.valueOf(mAnimationIsCancel));
    ...
    if (event.getActionMasked() == MotionEvent.ACTION_DOWN
      ...
      mRadiusAnimator.addListener(new Animator.AnimatorListener() {
        ...
        public void onAnimationEnd(Animator animator) {
          setRadius(0);
          ViewCompat.setAlpha(RippleView.this, 1);
          mIsAnimating = false;
        }
